...
if username:
    ...
    st.markdown(f"<span style='font-size: 24px;'>{total_hours}</span> **HOURS**   <span style='font-size: 24px;'>{distinct_directors}</span> **DIRECTORS**   <span style='font-size: 24px;'>{distinct_countries}</span> **COUNTRIES**   <span style='font-size: 24px;'>{distinct_languages}</span> **LANGUAGES**", unsafe_allow_html=True)
